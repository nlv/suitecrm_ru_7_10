...
Последняя попытка подключения @ ',
    ...
    'LBL_LDAP_BIND_ATTRIBUTE_DESC' => 'Пользователь для&nbsp;соединения с&nbsp;LDAP<br>Пример:<b>AD:</b>&nbsp;userPrincipalName,&nbsp;<b>openLDAP:</b>&nbsp;dn,&nbsp;<b>Mac&nbsp;OS&nbsp;X:</b>&nbsp;uid ',
    'LBL_LDAP_LOGIN_ATTRIBUTE_DESC' => 'Пользователь для&nbsp;соединения с&nbsp;LDAP<br>Пример:<b>AD:</b>&nbsp;userPrincipalName,&nbsp;<b>openLDAP:</b>&nbsp;dn,&nbsp;<b>Mac&nbsp;OS&nbsp;X:</b>&nbsp;uid ',
    ...
    'LBL_PASSWORD_GENERATE_TEMPLATE_MSG' => 'Для пароля, сгенерированного системой',
    'LBL_PASSWORD_LOST_TEMPLATE_MSG' => 'Для сгенерированной системой ссылки сброса пароля',
    'LBL_TWO_FACTOR_AUTH_EMAIL_TPL' => 'Для кода двухфакторной аутентификации, сгенерированного системой',
    ...
    'LBL_REPAIRXSS_INSTRUCTIONS' => 'Выберите модуль для удаления потенциальных XSS-строк. Выберите "Все" для обработки каждого модуля. <br>Нажмите кнопку Выполнить для начала процесса обнаружения / удаления уязвимостей.',
    'LBL_REPAIRXSS_REPAIRED' => 'объектов восстановлено',
    'LBL_REPAIRXSS_TITLE' => 'Удаление XSS-уязвимостей из базы данных',
    'LBL_RESET_CACHE' => 'Очистите кэш.', // PR 3007
    'LBL_RESET_CACHE_DESC' => 'Полностью очистить кэш, включая локальные и внешние хранилища с опкодами', // PR 3007
    ...
    'LBL_REPAIR_ORACLE_FULLTEXT' => 'Перестроить полнотекстовые индексы',
    ...
    'LBL_OAUTH2_CLIENTS_TITLE' => 'OAuth2 клиенты и ключи',
    ...
    'LBL_OAUTH2_TOKENS' => 'View session log and revoke active sessions', // to be removed PR 5321
    ...
    //FTS
    'LBL_DELETE_FTS_DATA' => 'Существующие данные при индексации удаляются. Будут проиндексированы только данные из выбранных модулей.',
    'LBL_SAVE_SCHED_BUTTON' => 'Сохранить и Настроить расписание индексирования',
    ...
    'LBL_JJWG_MAPS_ADMIN_GEOCODED_COUNTS_DESC' => 'Просмотр статистики геокодирования, данные по каждому модулю сгруппированы в зависимости от полученных результатов', // PR 4344
    ...
    'LBL_JJWG_MAPS_ADMIN_GEOCODING_TEST_DESC' => 'Запуск геокодирования введённого адреса с детальным просмотром результатов', // PR 4344
    'LBL_JJWG_MAPS_ADMIN_ADDRESS_CACHE_TITLE' => 'Кэш адресов',
    'LBL_JJWG_MAPS_ADMIN_ADDRESS_CACHE_DESC' => 'Просмотр кэшированных адресов.', // PR 4344
    ...
    'LBL_AOP_MEETING_RESPONSE_URL' => 'URL для входа в конференцию', // PR 3394
    'LBL_AOP_BUSINESS_HOURS_SETTINGS' => 'График работы',
    'LBL_AOP_BUSINESS_HOURS_DESC' => 'Разрешить запуск рабочих процессов только в определённое время', // PR 4344
    ...
    'LBL_SYNC_ERROR_FOUND' => "Обнаружены ошибки IMAP",
    'LBL_SYNC_ALERT_FOUND' => "Обнаружены предупреждения IMAP",
    'LBL_SYNC_NO_EMAIL' => "Нет импортированных писем, связанных с учётной записью входящей почты",
    'LBL_PROCESS_OUTPUT_CLEANUP_ERROR' => "Не удается очистить файл. Пожалуйста, проверьте разрешения..",
    'LBL_PROCESS_OUTPUT_WRITE_ERROR' => "Не удается записать файл. Пожалуйста, проверьте разрешения..",
    ...
    'LBL_PWDSEC_MIN_LENGTH_DESC' => 'Минимальная длина пароля',
    'LBL_PWDSEC_UPPERCASE' => 'Пароль должен содержать заглавные символы',
    'LBL_PWDSEC_UPPERCASE_DESC' => 'Пароль должен содержать заглавные символы',
    'LBL_PWDSEC_LOWERCASE' => 'Пароль должен содержать строчные символы',
    'LBL_PWDSEC_LOWERCASE_DESC' => 'Пароль должен содержать строчные символы',
    ...
    'LBL_PWDSEC_CHARS' => 'Символы',

    'MSG_CACHE_CLEANED' => 'Кэш пуст.', // PR 3007
    'MSG_NOT_CACHE_CLEANED' => 'Кэш не может быть очищен', // PR 3007
    'LBL_USER_LOCKOUT' => 'Блокировка пользователя', // PR 2897
    'LBL_MAX_FAILED_LOGINS' => 'Максимальное количество неудачных попыток входа', // PR 2897
    'LBL_MAX_FAILED_LOGINS_HELP' => 'Количество неудачных попыток входа до того, как учетная запись пользователя будет заблокирована.', // PR 2897
    'LBL_AUTO_UNLOCK_TIME' => 'Время автоматической разблокировки учетной записи пользователя', // PR 2897
    'LBL_AUTO_UNLOCK_TIME_HELP' => 'Число минут, через которое, учётная запись пользователя будет автоматически разблокирована.', // PR 2897
    'LBL_AUTO_UNLOCK_TIME_UNITS' => 'минут', // PR 2897
    'ERR_MAX_FAILED_LOGINS' => 'Пожалуйста, укажите правильное значение для максимального числа неудачных попыток входа', // PR 2897
    'ERR_AUTOMATIC_UNLOCK_TIME' => 'Пожалуйста, укажите правильное значение времени, через которое произойдёт автоматическая разблокировка', // PR 2897
    'LBL_ENABLE_MAX_FAILED_LOGINS' => 'Число неудачных попыток входа до блокировки пользователя', // PR 2897
    'LBL_AUTO_UNLOCK' => 'Автоматически разблокировать блокированных пользователей', // PR 2897
    'LBL_AUTO_UNLOCK_HELP' => 'Разблокировать блокированных пользователей через настраиваемый промежуток времени', // PR 2897
);
