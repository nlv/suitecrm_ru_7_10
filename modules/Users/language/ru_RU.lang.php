...
$mod_strings = array(
    'ERR_NO_2FACTOR_EMAIL_TMPL' => 'Не задан шаблон письма двухфакторной аутентификации, измените настройки на странице управления паролями.',
    'ERR_NO_2FACTOR_EMAIL_TMPL_CODE' => 'Шаблон письма двухфакторной аутентификации, по крайней мере, должен содержать $code.',
    ...
    'ERR_PASSWORD_ONEUPPER' => 'Пароль должен содержать заглавные символы.',
    'ERR_PASSWORD_ONELOWER' => 'Пароль должен содержать строчные символы.',
...
',
    ...
    'LBL_SUBTHEME_OPTIONS_NOON' => 'Полуденная', // Theme for WCAG color contrast compliant. see issues 4776
    'LBL_SUBTHEME' => 'Стиль',
    'LBL_LDAP' => 'LDAP',
    ...
    'LBL_PORTAL_ONLY_DESC' => 'Используется для Portal API. Этот тип не может войти через Web-интерфейс SuiteCRM.',
    'LBL_PORTAL_ONLY_USER' => 'Пользователь Portal API',
    ...
    'LBL_SORT_MODULES' => 'Отсортировать модули по алфавиту', //PR 4808
    'LBL_SORT_MODULES_DESCRIPTION' => 'Упорядочить модули по имени в ниспадающем меню.', //PR 4808
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_WIZARD_FINISH' => 'Кликните <b>Закончить</b>ниже, чтобы сохранить ваши настройки и начать работу в SuiteCRM. Для дополнительной информации по работе в SuiteCRM:<br /><br />
<table cellpadding=0 cellspacing=0> <tr><td><!--not_in_theme!-->Посетите www.suitecrm.com <img src=include/images/suitecrm_login.png style="margin-right: 5px;"> </td><td><a href="http://www.suitecrm.com/" target="_blank"><b>SuiteCRM</b></a></td></tr></table>',

    'LBL_WIZARD_FINISH1' => 'Что бы вы хотели сделать дальше?',
    'LBL_WIZARD_FINISH2' => 'Начать работу в SuiteCRM',
    'LBL_WIZARD_FINISH3' => 'Импортировать данные ',
    'LBL_WIZARD_FINISH4' => 'Импортировать данные из внешних источников в приложение.',
    'LBL_WIZARD_FINISH5' => 'Создать пользователей',
    'LBL_WIZARD_FINISH6' => 'Создайте новые учетные записи пользователей для доступа к приложению.',
    'LBL_WIZARD_FINISH7' => 'Просмотр и управление параметрами приложения',
    'LBL_WIZARD_FINISH8' => 'Управление дополнительными параметрами, включая параметры приложения по умолчанию.',
    'LBL_WIZARD_FINISH9' => 'Настройки приложения ',
    'LBL_WIZARD_FINISH10' => 'Использовать Studio для создания и управления полями и раскладками.',
    'LBL_WIZARD_FINISH11' => 'Посетить сайт SuiteCRM ',
    'LBL_WIZARD_FINISH12' => 'Найти учебные материалы и классы, которые помогут вам начать работу системным администратором или конечным пользователем приложения.',
    'LBL_WIZARD_FINISH14' => 'Документация ',
    'LBL_WIZARD_FINISH15' => 'Справочники по продукту и информация о выпуске ',
    'LBL_WIZARD_FINISH16' => 'База знаний ',
    'LBL_WIZARD_FINISH17' => 'Советы от SuiteCRM',
    'LBL_WIZARD_FINISH18' => 'Форумы ',
    'LBL_WIZARD_FINISH19' => 'Форумы сообщества SuiteCRM, где можно обсудить с другими пользователями и с разработчиками интересующие темы ',
    'LBL_WIZARD_FINISH2DESC' => 'Перейти непосредственно к домашней странице приложения.',
    'LBL_WIZARD_PERSONALINFO' => 'Информация о вас',
    ...
    'LBL_CHECKMARK' => 'Контрольный флаг' /* for 508 compliance fix */,
    ...
    'LBL_SEND_CONFIRM_OPT_IN' => 'Отправить эл. письмо для подтверждения выбора', // PR 4911
    'LBL_EMAIL_ATTACHMENT' => 'Вложение E-mail',
    'LBL_EMAIL_SELECTOR_SELECT' => 'Обзор',
    ...
    'LBL_BUTTON_DISTRIBUTE' => 'Назначение',
    ...
    'LBL_EMAIL_SETTINGS_INBOUND_ACCOUNTS' => 'Учётные записи',
    ...
    'ERR_USER_FACTOR_SMTP_REQUIRED' => 'Для начала, нужно задать параметры сервера SMTP.',
    'ERR_USER_FACTOR_CHANGE_DISABLED' => 'Вам запрещено изменять настройки двухфакторной аутентификации.',
    'LNK_IMPORT_CAMPAIGNS' => 'Импортировать кампании',
    'LBL_UNLOCK_USER' => 'Разблокировать пользователя',  // PR 2897
    'LBL_USER_UNLOCKED_MSG' => 'Пользователь разблокирован',  // PR 2897
); // END STRINGS DEFS
