...
$mod_strings = array(
    ...
    'LBL_UW_START_DESC2' => 'Настоятельно рекомендуем перед обновлением системы сделать резервные копии как базы данных, так и файлов SuiteCRM. Как известно, профилактика - лучшее лечение:<br/><br/><pre>composer update</pre>', // Keep the <pre>composer update</pre> words at the end of the sentence and do not translate it
    ...
    'LBL_PASSWORD_EXPIRATON_CHANGED' => 'Warning: password expiration is set to none!', // PR 5567
    'LBL_PASSWORD_EXPIRATON_REDIRECT' => 'Please update your settings here', // PR 5567
);
